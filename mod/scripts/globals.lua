-- Filter Combinator Mod - Global Storage Management
-- Central aggregator for all entity storage modules and shared state
-- CRITICAL: Uses Factorio 2.0 APIs - storage NOT global!
--
-- This module:
-- 1. Aggregates entity-specific storage modules (filter_combinator/storage.lua, etc.)
...
--- @param gui_type string The type of GUI opened (e.g., "filter_combinator")
...
--- @param gui_frame_name string|nil Optional GUI frame name to destroy
