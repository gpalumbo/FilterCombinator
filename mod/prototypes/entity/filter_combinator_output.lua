-- Filter Combinator Output Entity
-- Hidden constant combinator used for signal output
-- Created automatically when a Filter Combinator is built
-- Factorio 2.0 API

-- Constants
local default_circuit_wire_max_distance = 9  -- Standard Factorio circuit wire reach

-- Create hidden constant combinator for output signals
local output_combinator = table.deepcopy(data.raw["constant-combinator"]["constant-combinator"])

-- Basic properties
output_combinator.name = "filter-combinator-output"
...
-- Make sprites invisible using empty.png from core
...
log("[filter-combinator] prototypes/entity/filter_combinator_output.lua loaded")
